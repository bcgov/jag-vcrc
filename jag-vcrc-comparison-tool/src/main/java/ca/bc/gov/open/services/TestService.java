...
public class TestService {
  ...
  private boolean compare(UriComponentsBuilder builderWM, UriComponentsBuilder builderAPI) {
    var wmResp = restTemplate.exchange(
        builderWM.toUriString(), HttpMethod.GET, new HttpEntity<>(new HttpHeaders()), String.class);

    var apiResp = restTemplate.exchange(
            builderAPI.toUriString(), HttpMethod.GET, new HttpEntity<>(new HttpHeaders()), String.class);

    Diff diff = javers.compare(apiResp.getBody(), wmResp.getBody());
